...
const CATEGORIES = ['All', 'Luxury', 'Heritage', 'Private', 'Group', 'Eco'];
            ...
            <div className="container">
                <div style={{ marginBottom: '6rem' }} className="responsive-header">
                    <div className="flex flex-col items-center text-center" style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <span style={{ fontWeight: 800, fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.2em', color: 'var(--accent)', marginBottom: '1.5rem', display: 'block' }}>Elite Collections</span>
                        <h1 className="h1" style={{ marginBottom: '2.5rem' }}>Discover our <span style={{ color: 'var(--accent)' }}>Tours</span>.</h1>
                    </div>
                    ...
                    <div style={{
                        ...
                        <input
                            type="text"
                            placeholder="Find your next elite tour..."
                            value={searchTerm}
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center" style={{ padding: '100px 0' }}>
                        ...
                        <p style={{ marginTop: '1.5rem', fontWeight: 600, color: 'var(--text-muted)' }}>Curating elite tours for you...</p>
                    </div>
                    ...
                    <div style={{ textAlign: 'center', padding: '100px 0', background: 'var(--surface-main)', borderRadius: 'var(--radius-xl)', border: '1px solid var(--border-light)' }}>
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', fontWeight: 500 }}>No tours found matching your search.</p>
